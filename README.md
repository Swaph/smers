...
The project was developed as a capstone-style software engineering artifact and is suitable for graduate admissions review as evidence of end-to-end system design, implementation, and applied public-health problem framing.
...
Frontend runs on http://localhost:3000 and proxies API traffic to http://localhost:5000.
